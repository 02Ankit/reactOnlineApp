...
const About = () => {
  ...
  return (
    <View style={styles.aboutContainer}>
      <Text style={styles.mainHeader}> Abhijeet Dewangan </Text>
      ...
      <View style={styles.menuContainer}>
        <TouchableOpacity
          ...
          onPress={() =>
            Linking.openURL("https://www.instagram.com/02ankit89/")
          }>
          <Image
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Linking.openURL(
              "https://www.youtube.com/channel/UCjDkUed48T-HA1CRspoXu3w"
            )
          }>
          <Image
            style={styles.iconStyle}
